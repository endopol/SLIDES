\begin{tframe}{Inference and Planning}
\begin{center}
...
\bigskip
\visible<2>{\includegraphics{media_minrep/reduced_agent}}
\end{center}
\end{tframe}

\begin{tframe}{Discrete Decision Policy}
\begin{center}
\includegraphics[width=2in]{media_minrep/cdiag1}\quad
\phantom{\includegraphics[width=1.5in]{media_minrep/cdiag3}}
\end{center}
\end{tframe}
...
\visible<2>{\includegraphics[width=1.5in]{media_minrep/cdiag3}}
\end{center}
\end{tframe}

\begin{tframe}{Comparison with Greedy Methods}
\begin{center}
\begin{tabular}{cccc}
...
\begin{tframe}{Poisson Tree Comparisons}
\begin{center}
\begin{tabular}{cc}
